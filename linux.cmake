...
if(NOT _CMAKE_IN_TRY_COMPILE)
  ...
  set(CLANG_COMPILE_OPTIONS "-pthread -march=broadwell -mavx2 -mfpmath=sse -fasm -fPIC -D_DEFAULT_SOURCE=1" CACHE STRING "")
  ...
  set(CMAKE_SHARED_LINKER_FLAGS "${CMAKE_SHARED_LINKER_FLAGS} ${VCPKG_LINKER_FLAGS} -pthread -lc++fs" CACHE STRING "")
  set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} ${VCPKG_LINKER_FLAGS} -pthread -lc++fs" CACHE STRING "")
endif()
