...
if(NOT _CMAKE_IN_TRY_COMPILE)
  ...
  set(CMAKE_C_FLAGS_RELEASE "/Os /Oi /Oy /Ob2 /Gy /GS- /GF /GL /Z7 ${VCPKG_C_FLAGS_RELEASE} ${VCPKG_CRT_LINK_FLAG_PREFIX} /DNDEBUG" CACHE STRING "")
  set(CMAKE_CXX_FLAGS_RELEASE "/Os /Oi /Oy /Ob2 /Gy /GS- /GF /GL /Z7 ${VCPKG_CXX_FLAGS_RELEASE} ${VCPKG_CRT_LINK_FLAG_PREFIX} /DNDEBUG /await /await:heapelide" CACHE STRING "")
  ...
  if(CMAKE_BINARY_DIR MATCHES "^${VCPKG_ROOT}")
    set(CMAKE_STATIC_LINKER_FLAGS_DEBUG "/INCREMENTAL" CACHE STRING "")
