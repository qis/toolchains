...
# Base Flags
set(BASE_FLAGS "/W3 /wd4101 /wd4275 /wd4996 /wd26812 /wd28251 /diagnostics:column /FC")
set(BASE_FLAGS "${BASE_FLAGS} /DWIN32 /D_WIN64 /D_WINDOWS /DWINVER=0x0A00 /D_WIN32_WINNT=0x0A00")
set(BASE_FLAGS "${BASE_FLAGS} /D_CRT_SECURE_NO_DEPRECATE /D_CRT_SECURE_NO_WARNINGS /D_CRT_NONSTDC_NO_DEPRECATE")
set(BASE_FLAGS "${BASE_FLAGS} /D_ATL_SECURE_NO_DEPRECATE /D_SCL_SECURE_NO_WARNINGS")
set(BASE_FLAGS "${BASE_FLAGS} ${CHARSET_FLAG}")

# Compiler Flags
set(CMAKE_C_FLAGS "${BASE_FLAGS} ${VCPKG_C_FLAGS}" CACHE STRING "")
set(CMAKE_C_FLAGS_DEBUG "/Od /RTC1 ${VCPKG_DEBUG_FLAG} ${VCPKG_CRT_FLAG}d ${VCPKG_C_FLAGS_DEBUG}" CACHE STRING "")
...
set(CMAKE_C_FLAGS_RELWITHDEBINFO "/O1 /Oi /GS- ${VCPKG_DEBUG_FLAG} ${VCPKG_CRT_FLAG} /DNDEBUG ${VCPKG_C_FLAGS_RELEASE}" CACHE STRING "")
