...
set(CMAKE_C_FLAGS "/nologo ${LLVM_CPP_FLAGS} ${VCPKG_C_FLAGS}" CACHE STRING "")
set(CMAKE_CXX_FLAGS "/nologo ${LLVM_CPP_FLAGS} ${LLVM_CXX_FLAGS} ${VCPKG_CXX_FLAGS}" CACHE STRING "")
...
if(CMAKE_BINARY_DIR MATCHES "^${VCPKG_ROOT}")
  ...
  set(CMAKE_C_FLAGS_DEBUG "/Od /Oi- /Ob0 /Gy- /GS /RTC1 /ZI ${VCPKG_C_FLAGS_DEBUG} ${LLVM_CRT_FLAG}d" CACHE STRING "")
  set(CMAKE_CXX_FLAGS_DEBUG "/Od /Oi- /Ob0 /Gy- /GS /RTC1 /ZI ${VCPKG_CXX_FLAGS_DEBUG} ${LLVM_CRT_FLAG}d" CACHE STRING "")
endif()
...
set(CMAKE_SHARED_LINKER_FLAGS_RELEASE "/OPT:REF /OPT:ICF -flto=full" CACHE STRING "")
set(CMAKE_EXE_LINKER_FLAGS_RELEASE "/OPT:REF /OPT:ICF -flto=full" CACHE STRING "")
